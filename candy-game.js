// ------------------------------------------------------------------------
// How To Make A Candy Game With HTML5 Canvas
// Copyright (c) 2017 Ashwin Parmar
// 
...
//
// Tutorial: http://rembound.com/articles/how-to-make-a-match3-game-with-html5-canvas
// ------------------------------------------------------------------------
...
window.onload = function() {
    ...
    function drawFrame() {
        ...
        // Draw header
        context.fillStyle = "#dd11dd";
        context.fillRect(0, 0, canvas.width, 65);
        
        // Draw title
        context.fillStyle = "#ffffff";
        context.font = "24px Verdana";
        context.fillText("Candy Game Ver. 1.0", 10, 30);
    ...
    function drawTile(x, y, r, g, b) {
        ...
        switch(r.toString()+g.toString()+b.toString()) {
          case "255128128":
            context.drawImage(img, 960, 410, 160, 160, x + 2, y + 2, level.tilewidth - 4, level.tileheight - 4); // Red Fish
            break;
          case "128255128":
            context.drawImage(img, 1280, 795, 160, 160, x + 2, y + 2, level.tilewidth - 4, level.tileheight - 4); // Green Candy
            break;
          case "128128255":
            context.drawImage(img, 1580, 300, 160, 160, x + 2, y + 2, level.tilewidth - 4, level.tileheight - 4); // Orange Candy
            break;
          case "255255128":
            context.drawImage(img, 1600, 0, 160, 160, x + 2, y + 2, level.tilewidth - 4, level.tileheight - 4); // Yellow Candy
            break;
          case "255128255":
            context.drawImage(img, 1280, 0, 160, 160, x + 2, y + 2, level.tilewidth - 4, level.tileheight - 4); // Blue Round Candy
            break;
          case "128255255":
            context.drawImage(img, 625, 0, 160, 160, x + 2, y + 2, level.tilewidth - 4, level.tileheight - 4); // Red Fish
            break;
          case "255255255":
            context.drawImage(img, 450, 0, 160, 160, x + 2, y + 2, level.tilewidth - 4, level.tileheight - 4); // Orange Fish
            break;
        }
    }
